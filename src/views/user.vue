<template>
    <div class="box3"><!-- 用户中心盒子 -->
        <!-- 头像区域stare -->
        <div id="header">
            <img src="./picture/用户中心/1.jpg" alt="">
            <div id="text">
                <div id="header-1">
                    <p>昵称：沅子</p>
                    <p>ID：62981286</p>
        ...
        <div id="shoucang">
            <p id="label">收藏</p>
            <img src="./picture/用户中心/1.png" alt="">
        </div>
        <!-- 收藏end -->
        ...
        <div id="caogao">
            <p id="label">草稿</p>
            <div id="caogao-pic">
                <img src="./picture/用户中心/2.jpg" alt="">
                <img src="./picture/用户中心/3.jpg" alt="">
                <img src="./picture/用户中心/4.jpg" alt="">
            </div>
            <div id="chakan-container">
                <input type="button" value="查看更多" id="chakan">
            </div>
        </div>
        <!-- 草稿end -->
