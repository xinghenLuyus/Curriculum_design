<template>
  <div>
    ...
    <!-- 大屏 -->
    <div id="banner">
      <img src="../assets/picture/banner/1.jpg" alt="" />
    </div>
    ...
    <div id="container">
      <div id="rounded-rect">
        ...
        <a href="./委托约稿.html" target="_blank">委托约稿</a>
      </div>
      <div id="rounded-rect">
        <img src="../assets/picture/图标/06.png" alt="" />
        <a href="./创作中心.html" target="_blank">创作中心</a>
      </div>
      <div id="rounded-rect">
        <img src="../assets/picture/图标/07.png" alt="" />
        <a href="./同人分享.html" target="_blank">同人分享</a>
      </div>
    </div>
      ...
      <div id="box2">
        <div id="activity1">
          <table>
            ...
            <tr>
              <td colspan="2">
                <p>时间:5月6日—6月10日<br />类型:原创<br />主办:咔呲咯咯</p>
              </td>
            </tr>
          </table>
        </div>
        <div id="activity2">
          <table>
            ...
            <tr>
              <td colspan="2">
                <p>时间:6月6日—8月8日<br />类型:同人衍生<br />主办:异次元的住家君</p>
              </td>
            </tr>
          </table>
        </div>
        <div id="activity3">
          <table>
            ...
            <tr>
              <td colspan="2">
                <p>时间:7月21日—9月20日<br />类型:全部<br />主办:古古怪界</p>
              </td>
            </tr>
          </table>
        </div>
